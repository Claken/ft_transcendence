...
function Pong() {
  ...
  useEffect(() => {
    if (
      ...
      (game?.nameLP === auth.user.name || game?.nameRP === auth.user.name)
    ) {
    ...
    <div>
      {status === "queue" ? (
        <div className="wrapper">
          <button className="cta2" onClick={QueueOut}>
      ...
      {status === "join" ? (
        <div className="wrapper">
          <button className="cta" onClick={QueueIn}>
      ...
      {status === "invite" ? (
        <div className="wrapper">
          <button className="cta2" onClick={CancelInvite}>
